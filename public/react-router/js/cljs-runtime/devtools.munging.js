...
var o28807 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28807["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28808 = temp__5733__auto____$1;
return (o28808["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26474__auto__ = f;
return (o__26474__auto__["toString"]).call(o__26474__auto__);
} else {
return "";
}
}catch (e28809){var _ = e28809;
return "";
}});
...
try{var o__26474__auto___28984 = t;
(o__26474__auto___28984["cljs$lang$ctorPrWriter"]).call(o__26474__auto___28984,t,writer);
}catch (e28816){var __28985 = e28816;
}
...
var char_code = (function (){var o__26474__auto__ = (new String(char$));
return (o__26474__auto__["charCodeAt"]).call(o__26474__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26474__auto__ = String;
return (o__26474__auto__["fromCharCode"]).call(o__26474__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28821 = num_code;
switch (G__28821) {
case (1):
return (185);
...
var o__26474__auto__ = String;
return (o__26474__auto__["fromCharCode"]).call(o__26474__auto__,superscript_code);
});
/**
...
}catch (e28822){var _e__26481__auto__ = e28822;
return false;
}})())){
...
var vec__28823 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28823,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28826 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28826["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28827 = temp__5733__auto____$1;
return (o28827["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___29006 = arguments.length;
var i__4731__auto___29007 = (0);
while(true){
if((i__4731__auto___29007 < len__4730__auto___29006)){
args__4736__auto__.push((arguments[i__4731__auto___29007]));

var G__29008 = (i__4731__auto___29007 + (1));
i__4731__auto___29007 = G__29008;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28832){
var vec__28833 = p__28832;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28833,(0),null);
...
var G__29009 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29010 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29009;
remaining_tokens = G__29010;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28830){
var G__28831 = cljs.core.first(seq28830);
var seq28830__$1 = cljs.core.next(seq28830);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28831,seq28830__$1);
});
...
var vec__28838 = cljs.core.split_with((function (p1__28837_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__28837_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28838,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28838,(1),null);
...
var vec__28844 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28844,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28844,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29033 = cljs.core.rest(remaining_tokens);
var G__29034 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29033;
name_tokens = G__29034;
continue;
} else {
...
var vec__28850 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28850,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28850,(1),null);
var vec__28853 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28853,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28853,(1),null);
var vec__28856 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28856,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28856,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28856,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28856,(3),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28866 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28866,(1),null);
var vec__28869 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28869,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28869,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__28873 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__28873) : devtools.munging.parse_fn_info_deep.call(null,G__28873));
})()));
}
} else {
return fn_info;
...
var G__29049 = (arity + (1));
var G__29050 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28878){
var vec__28879 = p__28878;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28879,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28879,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__28886_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__28887_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28891){
var vec__28892 = p__28891;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28892,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28889){
var G__28890 = cljs.core.first(seq28889);
var seq28889__$1 = cljs.core.next(seq28889);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28890,seq28889__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28915__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28915__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28915__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28915__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28916 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28916,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28916,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28916,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28916,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28916,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28916,(5),null);
...
var o__26474__auto__ = f;
return (o__26474__auto__["getBasis"]).call(o__26474__auto__);
});
/**
...
}catch (e28920){var _e__26481__auto__ = e28920;
...
var G__29070 = (obj[cljs.core.first(path)]);
var G__29071 = cljs.core.rest(path);
obj = G__29070;
path = G__29071;
continue;
} else {
...
return (function (accum,p__28943){
var vec__28944 = p__28943;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28944,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28944,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28968){
var vec__28969 = p__28968;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28969,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28969,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28969,(2),null);
...
return (function (p__28977){
var vec__28978 = p__28977;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28978,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28978,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__28978,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__28972_SHARP_){
return (obj[cljs.core.first(p1__28972_SHARP_)]);
});})(name,sorted_matches,vec__28978,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
