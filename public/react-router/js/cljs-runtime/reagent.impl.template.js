...
var G__37724 = o;
(G__37724[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__37826.cljs$lang$applyTo = (function (arglist__37830){
var args = cljs.core.seq(arglist__37830);
...
var G__37727 = o;
(G__37727[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__37837__i < G__37837__a.length) {G__37837__a[G__37837__i] = arguments[G__37837__i + 0]; ++G__37837__i;}
  args = new cljs.core.IndexedSeq(G__37837__a,0,null);
} 
...
var args = cljs.core.seq(arglist__37838);
...
var G__37730 = props;
var G__37730__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37730,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37730);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37730__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__37732){
var map__37733 = p__37732;
var map__37733__$1 = (((((!((map__37733 == null))))?(((((map__37733.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37733.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37733):map__37733);
var props = map__37733__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37733__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__37733,map__37733__$1,props,class$){
return (function (c){
...
});})(map__37733,map__37733__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__37738){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37739__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__37739,map__37739__$1,on_write){
return (function (){
...
});})(node_value,map__37739,map__37739__$1,on_write))
);
} else {
...
var G__37742 = jsprops;
(G__37742["defaultValue"] = value);

(G__37742["onChange"] = ((function (G__37742,v,value,on_change){
return (function (p1__37741_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__37741_SHARP_);
});})(G__37742,v,value,on_change))
);
...
var vec__37744 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37744,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37744,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37744,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___37890 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___37890 == null)){
} else {
var key_37891 = temp__5739__auto___37890;
(jsprops["key"] = key_37891);
}
...
var temp__5739__auto___37892 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___37892 == null)){
} else {
var key_37893 = temp__5739__auto___37892;
reagent.impl.template.oset(jsprops,"key",key_37893);
}
...
var G__37748 = reagent.impl.template.__GT_NativeWrapper();
(G__37748["name"] = c);
...
var G__37749 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__37749) : reagent.impl.template.as_element.call(null,G__37749));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq37773){
var G__37774 = cljs.core.first(seq37773);
var seq37773__$1 = cljs.core.next(seq37773);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37774,seq37773__$1);
});
...
break;
default:
var G__37899 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__37899;
continue;
...
var n__4607__auto___37900 = a.length;
var i_37901 = (0);
while(true){
if((i_37901 < n__4607__auto___37900)){
(a[i_37901] = reagent.impl.template.as_element((a[i_37901])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___37903 = a.length;
var i_37904 = (0);
while(true){
if((i_37904 < n__4607__auto___37903)){
var val_37905 = (a[i_37904]);
if(((cljs.core.vector_QMARK_(val_37905)) && ((reagent.impl.template.key_from_vec(val_37905) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_37904] = reagent.impl.template.as_element(val_37905));

var G__37906 = (i_37904 + (1));
i_37904 = G__37906;
continue;
} else {
}
...
var ctx = ({});
var vec__37812 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37812,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37812,(1),null);
...
var G__37815 = (cljs.core.count(argv) - first_child);
switch (G__37815) {
case (0):
...
case (1):
var G__37816 = comp;
var G__37817 = jsprops;
var G__37818 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__37816,G__37817,G__37818);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__37815){
