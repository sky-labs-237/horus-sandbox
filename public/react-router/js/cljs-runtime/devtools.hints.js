...
var G__26558 = cljs.core.PersistentArrayMap.EMPTY;
var G__26559 = native_stack_trace;
var G__26560 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__26561 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__26558,G__26559,G__26560,G__26561) : cljs.stacktrace.parse_stacktrace.call(null,G__26558,G__26559,G__26560,G__26561));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26563__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26563__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26563__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e26562){var _e = e26562;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___26598 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___26598)){
var seen_errors_26599 = temp__5733__auto___26598;
if(cljs.core.truth_(seen_errors_26599.has(self))){
} else {
seen_errors_26599.add(self);

var temp__5735__auto___26600 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___26600)){
var sense_26601 = temp__5735__auto___26600;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26601)].join('');
} else {
}
}
} else {
