...
var G__34384 = devtools.prefs.pref(v);
v = G__34384;
continue;
} else {
return v;
...
}catch (e34345){var _e__31879__auto__ = e34345;
return false;
}})();
...
}catch (e34350){var _e__31879__auto__ = e34350;
return false;
}})();
...
}catch (e34354){var _e__31879__auto__ = e34354;
return false;
}}
}
});
...
var vec__34365 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34365,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34365,(1),null);
...
return cljs.core.some((function (p1__34369_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__34369_SHARP_);
}),template);
});
