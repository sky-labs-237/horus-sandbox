...
if(localFonts&&!Array.isArray(localFonts))throw Error("fontFace expects localFonts to be an array.");if(!Array.isArray(fileFormats))throw Error("fontFace expects fileFormats to be an array.");var fontReferences=[];localFonts&&fontReferences.push(generateLocalReferences(localFonts));fontFilePath&&fontReferences.push(generateFileReferences(fontFilePath,fileFormats));fontFilePath=fontReferences.join(", ");return JSON.parse(JSON.stringify({"@font-face":{fontFamily:fontFamily,src:fontFilePath,unicodeRange:_ref$fileFormats,
fontStretch:fontStretch,fontStyle:fontStyle,fontVariant:fontVariant,fontWeight:fontWeight,fontDisplay:fontDisplay,fontVariationSettings:fontVariationSettings,fontFeatureSettings:_ref}}))};module.exports=exports.default}
