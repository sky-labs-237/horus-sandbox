shadow$provide.module$node_modules$$material_ui$system$spacing=function(global,require,module,exports){function getTransformer(theme){var themeSpacing=theme.spacing||8;if("number"===typeof themeSpacing)return function(abs){return themeSpacing*abs};if(Array.isArray(themeSpacing))return function(abs){(0,_warning.default)(abs<=themeSpacing.length-1,["@material-ui/system: the value provided (".concat(abs,") overflows."),"The supported values are: ".concat(JSON.stringify(themeSpacing),"."),"".concat(abs,
" \x3e ").concat(themeSpacing.length-1,", you need to add the missing values.")].join("\n"));return themeSpacing[abs]};if("function"===typeof themeSpacing)return themeSpacing;(0,_warning.default)(!1,["@material-ui/system: the `theme.spacing` value (".concat(themeSpacing,") is invalid."),"It should be a number, an array or a function."].join("\n"));return function(){}}function getStyleFromPropValue(cssProperties,transformer){return function(propValue){return cssProperties.reduce(function(acc,cssProperty){if("string"===
typeof propValue)var JSCompiler_inline_result=propValue;else JSCompiler_inline_result=transformer(Math.abs(propValue)),JSCompiler_inline_result=0<=propValue?JSCompiler_inline_result:"number"===typeof JSCompiler_inline_result?-JSCompiler_inline_result:"-".concat(JSCompiler_inline_result);acc[cssProperty]=JSCompiler_inline_result;return acc},{})}}function spacing(props){var transformer=getTransformer(props.theme);return Object.keys(props).map(function(prop){if(-1===spacingKeys.indexOf(prop))return null;
var cssProperties=getCssProperties(prop);cssProperties=getStyleFromPropValue(cssProperties,transformer);prop=props[prop];return(0,_breakpoints.handleBreakpoints)(props,prop,cssProperties)}).reduce(_merge.default,{})}global=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:!0});exports.default=void 0;var _slicedToArray2=global(require("module$node_modules$$babel$runtime$helpers$slicedToArray")),_warning=global(require("module$node_modules$warning$warning")),
