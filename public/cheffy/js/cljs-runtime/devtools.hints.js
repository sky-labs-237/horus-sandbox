...
var G__31977 = cljs.core.PersistentArrayMap.EMPTY;
var G__31978 = native_stack_trace;
var G__31979 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__31980 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__31977,G__31978,G__31979,G__31980) : cljs.stacktrace.parse_stacktrace.call(null,G__31977,G__31978,G__31979,G__31980));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31982__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31982__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31982__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e31981){var _e = e31981;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___32018 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___32018)){
var seen_errors_32019 = temp__5733__auto___32018;
if(cljs.core.truth_(seen_errors_32019.has(self))){
} else {
seen_errors_32019.add(self);

var temp__5735__auto___32020 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___32020)){
var sense_32021 = temp__5735__auto___32020;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_32021)].join('');
} else {
}
}
} else {
